// src/pages/y3/numeracy/subtraction/SubtractionLayout.tsx

import React from 'react';
import { Link, NavLink, Outlet } from 'react-router-dom';

export const SubtractionLayout: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-yellow-100">
      <div className="max-w-6xl mx-auto p-4">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-bold text-purple-800">Subtraction</h1>
        ...
        <div className="flex gap-2 mb-4">
          ...
          <NavLink
            to="/y3/numeracy/subtraction/history"
            className={({ isActive }) =>
              `px-4 py-2 rounded-lg font-medium transition-colors ${
                isActive ? 'bg-purple-700 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'
              }`
