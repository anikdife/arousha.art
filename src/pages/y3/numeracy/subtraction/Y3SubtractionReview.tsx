// src/pages/y3/numeracy/subtraction/Y3SubtractionReview.tsx
...
// CRA-safe worker configuration: avoid `import.meta.url` which can break in
// some production bundles; use a CDN-hosted worker instead.
...
export const Y3SubtractionReview: React.FC = () => {
  ...
  const sessionTitle = useMemo(() => 'Subtraction Practice Session', []);
  ...
  useEffect(() => {
    const measure = () => {
      ...
      // Use client sizes to avoid feedback loops from borders/scrollbars.
    ...
    // Ensure we measure at least once even on browsers
    // that don't support ResizeObserver (some mobile/webviews).
  ...
  return (
    <div className="min-h-screen md:h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      <div className="h-full flex flex-col md:flex-row">
        {/* Info panel: top-middle on mobile, middle-left on wider devices */}
        ...
        {/* Canvas panel: full width on mobile, full height on desktop */}
